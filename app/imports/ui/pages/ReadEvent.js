...
const ReadEvent = ({ history, match: { params } }) => {
  ...
  const informations = [
    ...
    { label: i18n.__('pages.FormEvent.startRecur'), value: moment(state.startRecur).format('DD-MM-YYYY') },
    { label: i18n.__('pages.FormEvent.endRecur'), value: moment(state.endRecur).format('DD-MM-YYYY') },
